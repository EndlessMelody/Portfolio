...
const SparkleIcon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 20 20" className={className} aria-hidden>
    <path
      d="M10 0C10 5 15 10 20 10C15 10 10 15 10 20C10 15 5 10 0 10C5 10 10 5 10 0Z"
      fill="currentColor"
    />
  </svg>
);
...
const MagicCircle = () => (
  <svg
    className={styles.magicCircleSvg}
    viewBox="0 0 200 200"
  ...
  >
    ...
    />
    <path
      d="M 100 22 L 168 138 L 32 138 Z"
      fill="none"
      stroke="currentColor"
      strokeWidth="1.5"
    />
    <path
      d="M 100 178 L 168 62 L 32 62 Z"
      fill="none"
      stroke="currentColor"
      strokeWidth="1.5"
    />
...
export function Projects() {
  ...
  const leaves = [
    {
      ...
      back: (
        ...
        >
          <div className={styles.mysticOverlay} />
          <span className={styles.kanjiDeco}>壱</span>
        </div>
      ),
    },
    {
      ...
      back: (
        ...
        >
          <div className={styles.mysticOverlay} />
          <span className={styles.kanjiDeco}>弐</span>
        </div>
      ),
    },
    {
      ...
      back: (
        ...
        >
          <div className={styles.mysticOverlay} />
          <span className={styles.kanjiDeco}>参</span>
        </div>
      ),
    },
    {
  ...
  const getBookTransform = () => {
    ...
    if (currentPage === 0)
      return "translateX(-25%) rotateX(10deg) rotateY(-5deg)";
    if (currentPage === leaves.length)
      return "translateX(25%) rotateX(10deg) rotateY(5deg)";
  ...
  return (
    <section id="projects" className={styles.projects}>
      ...
      <div className="container">
        ...
        <div
          className={`${styles.bookContainer} reveal reveal-scale`}
              ...
              {leaves.map((leaf, index) => {
                ...
                return (
                  <div
                    ...
                    style={{ zIndex }}
                  >
                    <div className={styles.pageFront}>{leaf.front}</div>
                    <div className={styles.pageBack}>{leaf.back}</div>
                  </div>
                );
              })}
            </div>
  ...
  return (
    <div className={styles.projectContent}>
      ...
      <div className={styles.pageHeader}>
        <span className={styles.spellNumber}>
          SPELL NO. {String(index + 1).padStart(2, "0")}
        </span>
        <span className={styles.spellClass}>
          [ {project.accent.toUpperCase()} CLASS ]
        </span>
      </div>
      ...
      <div className={styles.techRunes}>
        {project.tech.map((t) => (
          <span key={t} className={styles.runeTag}>
            {t}
          </span>
        ))}
      </div>
